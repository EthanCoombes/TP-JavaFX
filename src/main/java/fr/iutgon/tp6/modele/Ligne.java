...
public class Ligne {
  private SimpleIntegerProperty qte = new SimpleIntegerProperty(0);
  private SimpleObjectProperty<Produit> produit = new SimpleObjectProperty<Produit>();;
  ...
  public Ligne(int qte, Produit produit) {
	  ...
	  FloatBinding prix = Bindings.selectFloat(this.produitProperty(), "prix");
	  FloatBinding Tva = Bindings.selectFloat(this.produitProperty(), "Tva");
	  totalHT = Bindings.multiply(this.qte, prix);
	  totalTTC = Bindings.multiply(Tva, totalHT);
  }
